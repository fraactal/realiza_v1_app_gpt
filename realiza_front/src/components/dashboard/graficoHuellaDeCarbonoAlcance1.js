...
import { data1, options3 } from '../../data/data'; // Importa los datos
    ...
    <div className="w-full h-96 flex items-center justify-center"> {/* Aumenta el alto */}
      <div className="w-full max-w-[600px] h-full"> {/* Ajusta el ancho máximo */}
        <h1 className="text-lg text-gray-800 mb-4 text-center mt-2">
          Huella de Carbono por fuente de emisión <strong>Alcance 1</strong>
        </h1>
        <div className="w-full h-full">
          <Bar data={data1} options={customOptions3} className="w-full h-full" />
        </div>
      </div>
    </div>
  );
...
export default GraficoAlcance1;
